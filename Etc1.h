// File: Etc1.h - Fast, high quality ETC1 block packer/unpacker - Rich Geldreich <richgel99@gmail.com>
...
// To pack large textures, it is highly recommended to call packEtc1Block() in parallel, on different blocks, from multiple threads (particularly when using High).
...
struct Etc1PackParams {
    Etc1Quality mQuality = Etc1Quality::High;
